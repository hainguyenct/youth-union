...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">{{ !empty($title) ? $title : 'Namhoc' }}</h4>
            </div>
        ...
        <div class="panel-body">
            ...
            <form method="POST" action="{{ route('namhocs.namhoc.update', $namhoc->id) }}" id="edit_namhoc_form" name="edit_namhoc_form" accept-charset="UTF-8" class="form-horizontal">
            {{ csrf_field() }}
