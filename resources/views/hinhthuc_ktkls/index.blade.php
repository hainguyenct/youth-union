...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">Hinhthuc Ktkls</h4>
            </div>
        ...
        @if(count($hinhthucKtkls) == 0)
            <div class="panel-body text-center">
                <h4>No Hinhthuc Ktkls Available.</h4>
            </div>
        @else
        <div class="panel-body panel-body-with-table">
            <div class="table-responsive">
                ...
                <table class="table table-striped ">
                    ...
                    <tbody>
                    @foreach($hinhthucKtkls as $hinhthucKtkl)
                        <tr>
                            <td>{{ $hinhthucKtkl->TEN_HT }}</td>
                            ...
                            <td>
                                ...
                                {{ csrf_field() }}
                                    ...
                                    <div class="btn-group btn-group-xs pull-right" role="group">
                                        <a href="{{ route('hinhthuc_ktkls.hinhthuc_ktkl.show', $hinhthucKtkl->ID ) }}" class="btn btn-info" title="Show Hinhthuc Ktkl">
