...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">Tinh Thanhphos</h4>
            </div>
        ...
        @if(count($tinhThanhphos) == 0)
            <div class="panel-body text-center">
                <h4>No Tinh Thanhphos Available.</h4>
            </div>
        @else
                            ...
                            <td>
                                ...
                                {{ csrf_field() }}
                                    ...
                                    <div class="btn-group btn-group-xs pull-right" role="group">
                                        <a href="{{ route('tinh_thanhphos.tinh_thanhpho.show', $tinhThanhpho->ID ) }}" class="btn btn-info" title="Show Tinh Thanhpho">
