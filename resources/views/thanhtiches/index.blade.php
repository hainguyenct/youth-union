...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">Thanhtiches</h4>
            </div>
        ...
        @if(count($thanhtiches) == 0)
            <div class="panel-body text-center">
                <h4>No Thanhtiches Available.</h4>
            </div>
        @else
        <div class="panel-body panel-body-with-table">
            <div class="table-responsive">
                ...
                <table class="table table-striped ">
                    ...
                    <tbody>
                    @foreach($thanhtiches as $thanhtich)
                        <tr>
                            ...
                            <td>
                                ...
                                {{ csrf_field() }}
                                    ...
                                    <div class="btn-group btn-group-xs pull-right" role="group">
                                        <a href="{{ route('thanhtiches.thanhtich.show', $thanhtich->ID ) }}" class="btn btn-info" title="Show Thanhtich">
