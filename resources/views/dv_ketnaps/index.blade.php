...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">Dv Ketnaps</h4>
            </div>
        ...
        @if(count($dvKetnaps) == 0)
            <div class="panel-body text-center">
                <h4>No Dv Ketnaps Available.</h4>
            </div>
        @else
        <div class="panel-body panel-body-with-table">
            <div class="table-responsive">
                ...
                <table class="table table-striped ">
                    <thead>
                        <tr>
                            <th>N G A Y K E T N A P</th>

                            <th></th>
                        </tr>
                    </thead>
                    <tbody>
                    @foreach($dvKetnaps as $dvKetnap)
                        <tr>
                            <td>{{ $dvKetnap->NGAYKETNAP }}</td>
                            ...
                            <td>
                                ...
                                {{ csrf_field() }}
                                    ...
                                    <div class="btn-group btn-group-xs pull-right" role="group">
                                        <a href="{{ route('dv_ketnaps.dv_ketnap.show', $dvKetnap->ID ) }}" class="btn btn-info" title="Show Dv Ketnap">
