...
@section('content')
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-heading clearfix">
            ...
            <div class="pull-left">
                <h4 class="mt-5 mb-5">Xeploai Cds</h4>
            </div>
        ...
        @if(count($xeploaiCds) == 0)
            <div class="panel-body text-center">
                <h4>No Xeploai Cds Available.</h4>
            </div>
        @else
            ...
            <div class="table-responsive">
                ...
                <table class="table table-striped ">
                    <thead>
                        <tr>
                            <th>T E N  P H</th>
                            <th>D I E M D A T  C D</th>

                            <th></th>
                        </tr>
                    </thead>
                    <tbody>
                    @foreach($xeploaiCds as $xeploaiCd)
                        <tr>
                            <td>{{ $xeploaiCd->TEN_PH }}</td>
                            <td>{{ $xeploaiCd->DIEMDAT_CD }}</td>
                            ...
                            <td>
                                ...
                                {{ csrf_field() }}
                                    ...
                                    <div class="btn-group btn-group-xs pull-right" role="group">
                                        <a href="{{ route('xeploai_cds.xeploai_cd.show', $xeploaiCd->ID ) }}" class="btn btn-info" title="Show Xeploai Cd">
